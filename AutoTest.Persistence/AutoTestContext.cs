...
public class AutoTestContext : DbContext
{
    ...
    public async Task SeedDatabaseAsync()
    {
        ...
        {
            if (await this.Clubs.FindAsync(1UL, CancellationToken.None) is null)
            {
            ...
            if (await this.Events.FindAsync(2UL, CancellationToken.None) is null)
            {
            ...
            if (await this.Events.FindAsync(3UL, CancellationToken.None) is null)
            {
            ...
            if (await this.Entrants.FindAsync(4UL, CancellationToken.None) is null)
            {
            ...
            if (await this.Entrants.FindAsync(5UL, CancellationToken.None) is null)
            {
            ...
            if (await this.Marshals.FindAsync(6UL, CancellationToken.None) is null)
            {
