    ...
    public class AutoTestContext : DbContext
    {
        ...
        public void SeedDatabase()
        {
            if (this.Database.ProviderName != "Microsoft.EntityFrameworkCore.InMemory")
            {
                ...
                {
                    var e = new Event(1, 1, "Kestrel Farm", new DateTime(2000, 1, 1), 10, 2, string.Empty, EventType.AutoTest, string.Empty, TimingSystem.StopWatch, new DateTime(), new DateTime());
