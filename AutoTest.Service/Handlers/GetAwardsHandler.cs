...
public sealed class GetAwardsHandler(ITestRunsRepository testRunsRepository, IEventsRepository eventsRepository, IEntrantsRepository entrantsRepository, ITotalTimeCalculator totalTimeCalculator) : IRequestHandler<GetAwards, Awards>
{
