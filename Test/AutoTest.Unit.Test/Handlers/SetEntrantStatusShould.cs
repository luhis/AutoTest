...
namespace AutoTest.Unit.Test.Handlers
{
    public class SetEntrantStatusShould
    {
        ...
        public async Task SetStatus()
        {
            var eventId = 11ul;
            var entrantId = 11ul;
            entrants.Setup(a => a.GetById(eventId, entrantId, CancellationToken.None)).ReturnsAsync(new Entrant(entrantId, 22, "joe", "bloggs", "joe@bloggs.com", Domain.Enums.EventType.AutoTest, "A", eventId, "BRMC", 1234, Domain.Enums.Age.Senior));
            var toSave = new Entrant(entrantId, 22, "joe", "bloggs", "joe@bloggs.com", Domain.Enums.EventType.AutoTest, "A", eventId, "BRMC", 1234, Domain.Enums.Age.Senior);
